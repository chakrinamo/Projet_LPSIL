...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		<div id="jsn-header">
			<div id="jsn-header-inner" class="clearafter">
				...
				<?php
					...
					if ($jsnutils->countModules('promo-top') > 0) { ?>
				<div id="jsn-promo-top">
					<div id="jsn-pos-promo-top">
						<jdoc:include type="modules" name="promo-top" style="jsnmodule" />
					</div>
				</div>
		...
		<?php
			/*====== Show modules in positions on footer wrapper ======*/
			if ($this->helper->countPositions('content-bottom-mid', 'content-bottom-below', 'footer', 'bottom')) {
		?>
				...
				<div id="jsn-content-bottom-mid">
					<div id="jsn-content-bottom-mid-inner">
						<div id="jsn-pos-content-bottom-mid">
							<jdoc:include type="modules" name="content-bottom-mid" style="jsnmodule" />
						</div>
					</div>
				</div>
			<?php
	...
	<div id="jsn-brand">
		JSN Fidem template designed by <a href="http://www.joomlashine.com" target="_blank" title="Free Hi-Quality Joomla Templates on JoomlaShine">JoomlaShine.com</a>
	</div>
